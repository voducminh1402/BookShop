...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/BookShop/vnpay_return.jsp";
    public static String vnp_TmnCode = "Q258LK7V";
    public static String vnp_HashSecret = "QVJLGFTKBVEQZZMKPBRRQEZVCHRUJHWB";
