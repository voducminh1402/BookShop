 ...
 * @author VODUCMINH
 */
@WebServlet(name = "GetListBookController", urlPatterns = {"/GetListBookController"})
public class GetListBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookDTO> productList = dao.getAllBook();
...
//            HttpSession session = request.getSession();
            ...
            log("Error at GetListBookController: " + e.toString());
        }
        finally {
