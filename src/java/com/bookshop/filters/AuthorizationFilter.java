...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (resource.contains("admin") || pathAction.contains("GetAllProduct")) {
                if (userLogin != null) {
            ...
            else if (resource.isEmpty() || resource.contains("filter-book.jsp") || resource.contains("404.jsp") || resource.contains("cart.jsp") || resource.contains("landing.jsp")
                    || resource.contains("cart.jsp") || resource.contains("product.jsp") || resource.contains("profile.jsp") ||
                    resource.contains("checkout.jsp") || resource.contains("category.jsp")
                    || pathAction.contains("GetBook") || pathAction.contains("GetLanding")) {
                if (userLogin != null) {
